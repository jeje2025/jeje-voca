...
import { HeaderInfo, LayoutOptionId, PdfWord, normalizeWordList } from './utils/pdfExportHelpers';
...
export default function ExportPage() {
  ...
  const handlePrint = () => {
    ...
    if (!pdfWords.length || !currentVocabId) {
      alert(errorMessage || '인쇄할 단어가 없습니다.');
      return;
    }
    const printUrl = new URL(window.location.href);
    printUrl.pathname = '/export/print';
    printUrl.searchParams.set('vocabularyId', currentVocabId);
    printUrl.searchParams.set('layout', selectedLayout);
  ...
  return (
    <>
      ...
      <div className="app-print-hidden print:hidden min-h-screen bg-gradient-to-br from-[#FDF2F8] via-[#F5F3FF] to-[#E0F2FE] pb-16">
