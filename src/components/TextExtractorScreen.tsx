...
export function TextExtractorScreen({ onBack }: TextExtractorScreenProps) {
  ...
  const handleAddToVocabulary = (words: any[]) => {
    // TODO: 기존 단어장에 추가하는 모달 열기
    toast.info(`${words.length}개 단어를 기존 단어장에 추가합니다.`);
  };

  const handleCreateNewVocabulary = (words: any[]) => {
    // TODO: 새 단어장 만들기 모달 열기
    toast.info(`${words.length}개 단어로 새 단어장을 만듭니다.`);
  };
      ...
      <div className="flex-1 overflow-y-auto scrollbar-hide px-4 pb-8">
        <div className="pt-2">
            ...
            {options.map((option) => {
              ...
              return (
                <motion.button
                  ...
                  className="relative bg-white/90 border border-gray-200 p-3 shadow-sm transition-all rounded-[20px]"
                >
                  {/* Check Mark */}
                  {isSelected && (
          ...
          <motion.div
            ...
            className="bg-white/95 backdrop-blur-lg p-6 shadow-lg rounded-[40px]"
          >
            ...
            <textarea
              ...
              className="w-full h-64 p-4 bg-[#F9FAFB] border border-gray-200 focus:border-[#491B6D] focus:outline-none resize-none text-[#374151] transition-colors rounded-[20px]"
            ...
            <div className="mt-4">
              ...
              <input
                ...
                className="w-full p-3 bg-[#F9FAFB] border border-gray-200 focus:border-[#491B6D] focus:outline-none text-[#374151] transition-colors rounded-[20px]"
                style={{ fontSize: '14px' }}
              />
            </div>
          </motion.div>
          ...
          <motion.button
            ...
            className={`w-full p-5 shadow-lg transition-all mt-4 rounded-[40px] ${
            ...
            >
              {results.vocabulary && results.vocabulary.length > 0 && (
                <VocabularyBox
                  ...
                  onCreateNewVocabulary={handleCreateNewVocabulary}
                />
              )}
