                  ...
                  <div className="p-4 space-y-3 bg-white">
                    ...
                    {sentence.translation && (
                      <div>
                        ...
                        <p className="text-sm text-gray-700">{sentence.translation}</p>
                      </div>
                    )}
                    {sentence.paraphrase && (
                      <div>
                        <div className="text-xs font-semibold text-purple-600 mb-1">의역</div>
                        <p className="text-sm text-gray-700">{sentence.paraphrase}</p>
                      </div>
                    )}
                    {sentence.summary && (
                      <div className="bg-yellow-50 p-2 rounded-lg">
                        <div className="text-xs font-semibold text-yellow-700 mb-1">한 줄 요약</div>
                        <p className="text-sm text-yellow-900">{sentence.summary}</p>
                      </div>
                    )}
                  </div>
                </motion.div>
